...
* @see app/Http/Controllers/CategoryController.php:18
* @route '/categories'
*/
...
* @see app/Http/Controllers/CategoryController.php:76
...
* @see app/Http/Controllers/CategoryController.php:90
* @route '/categories/{category}'
*/

...
* @see app/Http/Controllers/WarehouseController.php:55
...
* @see app/Http/Controllers/WarehouseController.php:63
...
* @see app/Http/Controllers/WarehouseController.php:79
* @route '/warehouses/{warehouse}'
*/

...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'العملاء', href: customersRoutes.index().url }];
                                    ...
                                    return (
                                        <tr key={c.id}>
                                            ...
                                            <td className="px-4 py-2 text-sm">
                                                ...
                                                {balance === 0 && <div className="text-xs text-gray-500">لا يوجد رصيد مدين</div>}
                                            </td>

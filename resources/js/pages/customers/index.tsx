...
type CustomerRow = { id: number; name: string; phone?: string | null; is_active: boolean }
...
const routes = {
    ...
    edit: (id: number) => ({ url: `/customers/${id}/edit` }),
    destroy: (id: number) => ({ url: `/customers/${id}` }),
}
                        ...
                        <tbody className="divide-y divide-border bg-background">
                            {customers.data.map((c) => (
                                <tr key={c.id}>
                                    ...
                                    <td className="px-4 py-2 text-sm">{c.is_active ? 'نعم' : 'لا'}</td>
                                    <td className="px-4 py-2 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <Link href={routes.edit(c.id).url} className="inline-flex">
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    router.delete(routes.destroy(c.id).url, {
